...
```bash
# Linux/Mac
curl -s https://raw.githubusercontent.com/DonArtkins/flaskify/main/flaskify-install.sh | bash
```
```bash
# Windows
iex ((New-Object System.Net.WebClient).DownloadString('https://raw.githubusercontent.com/DonArtkins/flaskify/main/flaskify-install.ps1'))
```
